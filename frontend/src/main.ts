...
const routes = [
  ...
  { path: '/api-management', redirect: '/api-management/index' },
  { path: '/api-management/index', name: 'ApiManagementIndex', component: () => import('./pages/ApiManagement/Index.vue'), meta: { requiresAuth: true } },
  { path: '/api-management/internal', name: 'ApiManagementInternal', component: () => import('./pages/ApiManagement/InternalApis.vue'), meta: { requiresAuth: true } },
  { path: '/api-management/external', name: 'ApiManagementExternal', component: () => import('./pages/ApiManagement/ExternalApis.vue'), meta: { requiresAuth: true } },
